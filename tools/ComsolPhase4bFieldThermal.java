...
public class ComsolPhase4bFieldThermal {
  public static void main(String[] args) throws Exception {
    String out = args.length > 0 ? args[0] : "E:\\RND_Project_Portfolio\\08_rf_cavity_cae_multiphysics\\models\\comsol\\phase4b_field_derived_rf_loss.mph";

    Model model = ModelUtil.create("Model");
    model.modelPath("E:\\RND_Project_Portfolio\\08_rf_cavity_cae_multiphysics\\models\\comsol");
    model.label("phase4b_field_derived_rf_loss.mph");
    ...
    model.result("pgT").label("Field-derived RF heating temperature field");
    ...
    model.result().export("imgT").set("pngfilename", "E:\\RND_Project_Portfolio\\08_rf_cavity_cae_multiphysics\\results\\phase4b\\field_loss_temperature_field.png");
